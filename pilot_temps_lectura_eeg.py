...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Brainvitge\\Desktop\\Clara\\pilot_eeg_Mundet\\pilot_temps_lectura_eeg.py',
...
load = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('Triggers_list4.xlsx'),
    seed=None, name='load')
