...
function setting_JSRoutineBegin(snapshot) {
  return function () {
    ...
    setting_JSComponents.forEach( function(thisComponent) {
...
function loading_phrasesRoutineBegin(snapshot) {
  return function () {
    ...
    loading_phrasesComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    // check if the Routine should terminate
...
function setting_parametersRoutineBegin(snapshot) {
  return function () {
    ...
    setting_parametersComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    // check if the Routine should terminate
...
function pausaRoutineBegin(snapshot) {
  return function () {
    ...
    pausaComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    // check if the Routine should terminate
...
function check_practRoutineBegin(snapshot) {
  return function () {
    ...
    check_practComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    // check if the Routine should terminate
...
function intertrialRoutineBegin(snapshot) {
  return function () {
    ...
    intertrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    // check if the Routine should terminate
